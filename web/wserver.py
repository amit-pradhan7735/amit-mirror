...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://graph.org/file/9acb6f716c8e75b1656ab.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://graph.org/file/9acb6f716c8e75b1656ab.jpg"
          alt="logo"
        />
        <a href="https://t.me/woodcraft5">
          <h2 class="name">Qbittorrent Selection-WOODcraft</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/tele-v1/mirror-lover"><i class="fab fa-github"></i></a>
        <a href="https://t.me/woodcraft5"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See mirror-lover <a href='https://github.com/tele-v1/mirror-lover'>@GitHub</a> By <a href='https://github.com/tele-v1'>Code mirror-lover</a></h1>"
